...
public class MapExercises {
    ...
    public static void finalGrades(){
        String[] names = {"Angie", "Dave", "Lisi", "Raja", "Shashi", "Bas", "Carlos", "Amber", "Rex", "Jason", "Nikolay"};
        System.out.println(getOriginalGrades().values());
        for (int i=0; i<getOriginalGrades().values().size();i++){
            System.out.println();
        }
    }
}
